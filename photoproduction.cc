...
int main(int argc, char* argv[]) {
      ...
      for (int i = 0; i < pythia.event.size(); ++i){
          ...
          if(pythia.event[i].id() == 11 && pythia.event[i].mother1() == 0 && pythia.event[i].mother2() == 0) {
          	if (pythia.event[i].status() > 0)
          		count[0]++; //Stores the Beam electrons.
          	...
          	if(pythia.event[d1].id() == 11 && pythia.event[i].isFinal())
          		count[1]++;	//daughter1 of the incoming beam electron
          	if(pythia.event[d2].id() == 11 && pythia.event[i].isFinal())
          		count[2]++;	//daughter2 of the incoming beam electron
  ...
  cout << "Number of Events : " << nEvent << endl;
	int x=0;
	cout << "Beam Electrons (No Mother Particles): " << count[0] << endl << "Final State e with Daughter1 = e:  " << count[1] << endl <<"Final State e with Daughter2 = e:  " << count[2] << endl << "Any Final State Beam Electron? : "<< count[3] << endl;
