...
int main(int argc, char* argv[]) {
  ...
  //TTree *data = new TTree("data","4-Momentum of all Charged Final State Particles");
  
  //data->Branch("px", "std::vector<Float_t>",  &px);
  //data->Branch("py", "std::vector<Float_t>",  &py);
  //data->Branch("pz", "std::vector<Float_t>",  &pz);
  //data->Branch("e", "std::vector<Float_t>",  &e);
  ...
  //TNtuple *fourmom = new TNtuple("fourmom","4-Momentum of all the final state charged particles","x:y:z:e");
